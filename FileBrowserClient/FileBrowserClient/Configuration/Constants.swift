...
struct Constants {
    // ContentView
    static var maxKnownServers: Int = 5

    // BackgroundLogin
    static var backgroundLoginFrequency: Double = 5.0
    static var backgroundLoginBuffer: Double = 30.0
    ...
    // Only render first 100 items initially
    static var filesDisplayLimit: Int = 100

    static var uploadCleanupDelay: Int = 2

    static var searchRequestTimeout: Double = 30.0
    static var searchResourceTimeout: Double = 45.0

    // Request:
    static var defaultRequestTimeout: Double = 3.0
    static var defaultResourceTimeout: Double = 5.0

    // RemoteThumbnail:
    // Maximum number of thumbnails to render
    static var maxConcurrentThumbnailRender: Int = 4
    static var thumbnailQuality: CGFloat = 0.1
    static var thumbnailRetryLimit: Int = 10
    static var thumbnailResourceTimeout: Double = 10.0
    static var thumbnailRequestTimeout: Double = 60.0
    static var maxThumbnailSize: CGFloat = 320
    // 10 MB is the max GIF filesize that can be rendered as a thumbnail
    static var maxGIFThumbnailBytes: Int = 10_000_000
    ...
    // PhotoPicker:
    // Maximum number of tasks that copy files to temp directory before upload
    static var maxUploadStagingLimit: Int = 5

    // Log
    // Maximum number of lines in a log file before the file is appending with an index
    static var maxLinesPerLogFile: Int = 1_000
    static var logFilePrefix: String = "filebrowser"

    // MetricsView
    static var lineChartMaxVisibleCount: Int = 100
    static var lineChartGridLineCount: Int = 4

    // Utils
    // 100 MB preview limit
    static var previewSizeLimit: Int = 100_000_000
